...
# Instructions summary
  1. [Interface Implementation](https://github.com/rdkcentral/entservices-monitor/blob/develop/.github/instructions/Plugin.instructions.md#interface-implementation)
  2. [Service Registration](https://github.com/rdkcentral/entservices-monitor/blob/develop/.github/instructions/Plugin.instructions.md#service-registration)
  3. [JSON-RPC Stub Registration](https://github.com/rdkcentral/entservices-monitor/blob/develop/.github/instructions/Plugin.instructions.md#json-rpc-stub-registration)
  4. [Handling Out-of-Process Plugin Failures](https://github.com/rdkcentral/entservices-monitor/blob/develop/.github/instructions/Plugin.instructions.md#handling-out-of-process-plugin-failures)
